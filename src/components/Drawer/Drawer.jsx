...
import { orderCardsAction } from '../../store/cardReducer';
import { CartCard } from '../CartCard/CartCard';

export const Drawer = ({setDrawerState, cartCards, orderState, setOrderState}) => {
	...
	const makeOrderDone = () => {
		setOrderState(true);
		dispatch(orderCardsAction(cartCards));
	};
